...
public class StripeService {
	...
	static {
		Stripe.apiKey = "1".equals(System.getProperty("PRODUCTION_MODE")) ? System.getProperty("STRIPE")
				: System.getProperty("STRIPE_TEST");
	}
	...
	public static String createUser(String userid, String email, String cardNumber, String expMonth, String expYear,
			String cvc, String token) throws AuthenticationException, InvalidRequestException, APIConnectionException,
	...
	public static String getDefaultCardId(String customerId) throws AuthenticationException, InvalidRequestException,
	...
	public static String updateCustomerCreditCard(String customerId, String cardNumber, String expMonth, String expYear,
			String cvc) throws AuthenticationException, InvalidRequestException, APIConnectionException, CardException,
			APIException {
	...
	public static String addNewCard(String customerId, String cardNumber, String expMonth, String expYear, String cvc)
	...
	public static String addNewCard(String customerId, String token) throws AuthenticationException,
	...
	public static boolean deleteCard(String customerId, String cardId) throws AuthenticationException,
			InvalidRequestException, APIConnectionException, CardException, APIException {
		Customer customer = Customer.retrieve(customerId);
	...
	public static String createSubscription(String customerId, String planId, String couponCode)
			throws AuthenticationException, InvalidRequestException, APIConnectionException, CardException,
			APIException {
		Customer customer = Customer.retrieve(customerId);
		Map<String, Object> params = new HashMap<>();
	...
	public static boolean deleteSubscription(String customerId, String subscriptionId) throws AuthenticationException,
			InvalidRequestException, APIConnectionException, CardException, APIException {
	...
	public static String createMembershipPlan(String planId, String planName, String amount, String interval)
			throws AuthenticationException, InvalidRequestException, APIConnectionException, CardException,
	...
	public static boolean deleteMembershipPlan(String planId) throws AuthenticationException, InvalidRequestException,
			APIConnectionException, CardException, APIException {
	...
	public static String listAllPlans() throws AuthenticationException, InvalidRequestException, APIConnectionException,
			CardException, APIException {
	...
	public static String charge(Integer amount, String cardNumber, String expMonth, String expYear, String customerID)
			throws AuthenticationException, InvalidRequestException, APIConnectionException, CardException,
			APIException {
	...
	public static String charge(Integer amount, String customerId, String cardId) throws AuthenticationException,
			InvalidRequestException, APIConnectionException, CardException, APIException {
		Map<String, Object> params = new HashMap<>();
		params.put("amount", amount);
